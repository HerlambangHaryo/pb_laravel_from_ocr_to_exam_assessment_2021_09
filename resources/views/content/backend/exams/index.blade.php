                ...
                <div class="table-responsive m-t-20">               
                    <table id="data-table-default" class="table table-striped table-bordered">
                        <thead>
                            <tr>               
                                <x-cv42.th-first/>            
                                <x-cv42.th-content title="Faculty" />
                                <x-cv42.th-content title="Course" />
                                <x-cv42.th-content title="Exam" />
                                <x-cv42.th-content title="Exam Date" />
                                <x-cv42.th-content title="Scan Date" />
                                <x-cv42.th-content title="Format" />
                                <x-cv42.th-last/>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @forelse ($data as $row)
                                    ...
                                    <td class="with-btn" nowrap> 
                                        <div class="btn-group m-r-5 m-b-5">
                                            ...
                                            <ul class="dropdown-menu">               
                                                <x-cv42.dropdown-li-a link="{{ route('Student_exams.show', $row->id) }}" icon="ion-ios-eye" title="show"/>
                                ...
                                @empty 
                                    <x-message.tr-no-record-data col="8"/>
                            @endforelse
                        </tbody>
                    </table>        
                </div>
