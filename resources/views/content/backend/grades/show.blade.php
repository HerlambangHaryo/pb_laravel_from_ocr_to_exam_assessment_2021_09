    ...
    <div id="content" class="content">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route($content.'.destroy', $Grade->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="form-group row m-b-15">    
                        ...
                        <div class="col-md-5">
                            <input type="text" 
                                ...
                                value       = "{{ old('title', $Grade->nama) }}" disabled/>
                    ...
                    <div class="form-group row m-b-15">    
                        ...
                        <div class="col-md-5">
                            <input type="text" 
                                ...
                                value       = "{{ old('title', $Grade->min) }}" disabled/>
                    ...
                    <div class="form-group row m-b-15">    
                        ...
                        <div class="col-md-5">
                            <input type="text" 
                                ...
                                value       = "{{ old('title', $Grade->max) }}" disabled/>
